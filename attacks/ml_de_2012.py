            ...
            for num in range(len(target_label)):
                ...
                for i in range(500):
                    if data.loc[i][flag + 1] == 1:
                        ...
                        break
                dom = xml.dom.minidom.parse('../data/voc2012/VOCdevkit/VOC2012/Annotations/' + img_name + '.xml')
                ...
                img = Image.open('../data/voc2012/VOCdevkit/VOC2012/JPEGImages/' + img_name + '.jpg')
                part = img.crop(pos)
